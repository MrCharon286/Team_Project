...
@Getter
@Setter
@ToString(exclude="superCtgno")		// System.out.println(this)으로 출력할 때 무한 루프 방지
@AllArgsConstructor
@NoArgsConstructor
@Builder
@Entity
public class Category {
	...
	@OneToMany(mappedBy = "superCtgno", fetch=FetchType.EAGER, cascade=CascadeType.ALL)
	private List<Category> categories;
	
	public void addCategory(Category child) {
		if(this.categories==null)
			this.categories = new ArrayList<>();
		child.setSuperCtgno(this);
